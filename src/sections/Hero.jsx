        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
              ...
              <span>Follow me: </span>
              {[
                { icon: FiGithub, href: "https://github.com/katedaboss" },
                {
                  icon: FiLinkedin,
                  href: "https://www.linkedin.com/in/ucherike-catherine-77a2192a5",
                },
                { icon: BsTwitterX, href: "https://x.com/katedaboss1" },
              ].map((social, idx) => (
                <a
                  key={idx}
                  href={social.href}
          ...
          <div className="relative animate-fade-in animation-delay-300">
            ...
            <div className="relative max-w-md mx-auto">
              ...
              <div className="relative glass rounded-3xl p-2 glow-border">
                ...
                {/* floating Badge */}
                <div className="absolute -bottom-4 -right-4 glass rounded-xl py-3 animate-float px-4 ">
